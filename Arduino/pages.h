const char page1[] PROGMEM =
   ...
   "body{width:430px;display:block;margin-left:auto;margin-right:auto;text-align:right;font-family: Arial, Helvetica, sans-serif;}\n"
   "</style>\n"
   ...
   "//ws=new WebSocket(\"ws://192.168.0.112/ws\")\n"
   ...
   "   w=0\n"
   "   for(wd=0;wd<8;wd++) if(wks[wd].checked) w|=(1<<wd)\n"
   "   save=false\n"
   ...
   "\n"
   "<tr><td>Name &nbsp </td><td colspan=2><small>En Su Mo Tu We Th Fr Sa</small>&nbsp Time &nbsp Duration Level</td></tr>\n"
   "</table>\n"
