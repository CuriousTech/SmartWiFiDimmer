const char page1[] PROGMEM =
   ...
   "//ws=new WebSocket(\"ws://192.168.0.102/ws\")\n"
   ...
   "<table align=\"right\" width=\"450\">\n"
   "<tr><td>PPKWH</td><td align=\"left\"><input name=\"ppkw\" type=text size=3> &nbsp;<label for=\"watts\"> Watts</label><input name=watts type=text size=1> </td><td>WH<input id=\"wh\" name=\"wh\" type=button size=8 onclick=\"clearWh();\"> $<input id=\"cost\" name=\"cost\" type=button size=8 onclick=\"clearWh();\">\n"
   "</td></tr>\n"
   "<tr><td><div id=\"rssi\">0db</div></td><td colspan=2><div id=\"ts\">1:00:00</div></td></tr>\n"
   "<tr><td id=\"MOT\">Motion</td><td><input name=\"mtime\" type=text size=4 style=\"width: 60px\">\n"
   " <input value='Save' type=button onclick=\"setData();\"> <input value='Restart' type=button onclick=\"setVar('reset',0);\"> </td><td> <input id=\"myKey\" name=\"key\" type=text size=50 placeholder=\"password\" style=\"width: 128px\">\n"
