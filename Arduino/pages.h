const char page1[] PROGMEM =
   ...
   "{\n"
   "console.log('cmd;{\"key\":\"'+a.myKey.value+'\",\"'+varName+'\":'+value+'}')\n"
   "\n"
   ...
   "on=(a.LED2.value=='OFF')\n"
   "setVar('led2',on)\n"
   "a.LED2.value=on?' ON ':'OFF'\n"
   "a.LED2.setAttribute('style',on?'color:blue':'')\n"
   "}\n"
   "\n"
   "function t2hms(t)\n"
   "{\n"
   ...
   "  inp.size=11\n"
   "  inp.value=arr[0]\n"
   "  inp.onclick = function() {console.log(this); }\n"
   "  td.appendChild(inp)\n"
   "\n"
   "  inp=document.createElement(\"input\")\n"
   "  inp.id='ON'+idx\n"
   "  inp.type='button'\n"
   "  inp.value=arr[3]?'ON':'OFF'\n"
   "  inp.size=3\n"
   "  td.appendChild(inp)\n"
   "\n"
   "  inp=document.createElement(\"input\")\n"
   ...
   "  inp.max=100\n"
   "  inp.size=2\n"
   "  inp.onchange=function(){console.log(this); }\n"
   "  td.appendChild(inp)\n"
   "\n"
   "  tr=document.createElement(\"tr\")\n"
   "  tr.id='dv'+idx\n"
   ...
   "<table align=\"right\" width=\"450\">\n"
   "<tr><td><div id=\"rssi\">0db</div></td><td>PPKW<input name=\"ppkw\" type=text size=3> &nbsp Watts\n"
   " <input name=watts type=text size=1> </td><td>WH<input id=\"wh\" name=\"wh\" type=button size=8 onclick=\"clearWh();\"> Cost<input id=\"cost\" name=\"cost\" type=button size=8 onclick=\"clearWh();\">\n"
   "</td></tr>\n"
